...
const productoPrecio=productos.map((producto)=>{
    return{
...
//! EJEMPLO UNO
const numerosCuadrador = [1,2,3,4,5]

const resultado = numerosCuadrador.map((numero) =>{
...
//! EJEMPLO UNO en una linea de codigo que se sobrenetiende

const resultado2 = numerosCuadrador.map((numero) => Math.pow(numero, 2))
console.log(resultado2)


// const nombres = ["luis", "mario", "pedro"]

// nombres.map((personas, indice) => {
